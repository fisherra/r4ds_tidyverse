...
This is where stringr really becomes handy. Combining stringr functions with regular expressions allows the functions to sort through lengthy datasets, manipulating them exactly as you command. These tables, copied from RStudio's stringr [cheatsheet](link) provides an excellent overview of regular expressions and how to use them.  
...
INSERT ALTERNATES AND ANCHORS TABLE

<br> 

If you're still not sure on how regular expressions work, check out [this](https://stringr.tidyverse.org/articles/regular-expressions.html) arcticle on the stringr website. 
